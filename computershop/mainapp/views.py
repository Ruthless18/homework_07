...
class CategoriesView(CartMixin, View):
...
class ChangeQTYView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        cart_product.save()
        recalc_cart(self.cart)
        messages.add_message(request, messages.INFO, "Количество обновлено")
        return HttpResponseRedirect('/cart/')
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_order.zip_code = form.cleaned_data['zip_code']
            ...
            messages.add_message(request, messages.INFO, 'Заказ успешно оформлен. Скоро с Вами свяжутся')
